...
import { Badge, ChevronsUpDown, Code, FolderOpen, Star} from "lucide-react";
  ...
  return (
    <div className="space-y-3">
      ...
      <DropdownMenu>
        ...
        >
          <div className="px-2 py-1.5 text-[10px] uppercase tracking-wider text-[#FFFBF4]">
            Your Projects
          </div>
          <DropdownMenuSeparator className="bg-white/10" />

          {projects.length === 0 ? (
            <div className="px-4 py-6 text-center text-[#FFFBF4]">
              ...
              {projects.map((project) => {
                ...
                return (
                  <DropdownMenuRadioItem
                    ...
                    className="cursor-pointer text-[#FFFBF4] focus:bg-white focus:text-[#FAFAFA]"
                  >
